...
// **********************************************
    ...
    static String subscriptionKey = "e9064273768245b99f569e59184acbb8";
    ...
    public String prettify(String json_text) {
        ...
        System.out.println(json.getAsJsonObject("webPages").getAsJsonObject("url"));
        Gson gson = new GsonBuilder().setPrettyPrinting().create();
        return gson.toJson(json);
    }

    public void Search (String searchTerm) {
        searchTerm = searchTerm.replaceAll("‘l'", "");
        ...
        try {
            ...
            //System.out.println("\nJSON Response:\n");
            //System.out.println(
            prettify(result.jsonResponse);
            //java.awt.Desktop.getDesktop().browse(new URI(result.jsonResponse));
        }
        catch (Exception e) {
